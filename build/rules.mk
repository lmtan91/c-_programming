...
DIR_TARGETS += \
	$(PLATFORM_TARGET_KERNLIBS) \
	$(PLATFORM_TARGET_MODULES) \
	$(NULL)
ND_DIR_TARGETS += \
	$(PLATFORM_ND_TARGET_KERNLIBS) \
	$(PLATFORM_ND_TARGET_MODULES) \
	$(NULL)
endif
...
DEPS_$(DIR) += $(TOPSRCDIR)/build/Make.Defaults
DEPS_$(DIR) += $(TOPSRCDIR)/build/rules.mk
...
# Handle the missing headers case by manually checking dependency list
FORCE_CHECK_DEPS := $(shell $(PERL) $(TOPSRCDIR)/build/check_deps.pl $(GEN_DEPS_$(DIR)))
...
# Translation layer for old build
CFLAGS += $(CFLAGS_$(DIR))
